...
public class Lista02_Prof_Kalil {
    ...
    public static void main(String[] args) {
        ...
        // Executa o método correspondente à opção selecionada
        switch (opcao) {
            case 1:
                subtracao();
                break;
    ...
    public static void subtracao() {
        // Exibe uma mensagem de boas-vindas e solicita dois números ao usuário
        System.out.println("-------------------------------");
    ...
    public static void divisao() {
        ...
        if (divisor != 0) {
            // Realiza a divisão dos números e exibe o resultado
    ...
    public static void mediaPonderada() {
        // Exibe uma mensagem de boas-vindas e solicita três notas e pesos ao usuário
        System.out.println("-------------------------------");
        System.out.println("|Bem Vindo(a), ao programa que|");
        ...
        // Calcula a média ponderada das notas e exibe o resultado
    ...
    public static void mediaAritmetica() {
        // Exibe uma mensagem de boas-vindas e solicita três notas ao usuário
        System.out.println("-------------------------------");
        System.out.println("|Bem Vindo(a), ao programa que|");
        ...
        // Calcula a média aritmética das notas e exibe o resultado
    ...
    public static void percentual() {
        // Exibe uma mensagem de boas-vindas e solicita o salário ao usuário
        System.out.println("-------------------------------");
        System.out.println("|Bem Vindo(a), ao programa que|");
        ...
        // Calcula a gratificação, salário bruto, imposto e salário líquido
